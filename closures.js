...
var potentialSecondLevelFriends = secondLevelFriends.filter(findPotentialFriends(friends), true);
var allPotentialFriends = allUsers.filter(findPotentialFriends(friends), true);
